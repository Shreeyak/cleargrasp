...
// Configure all streams to run at given resolution at 30 frames per second.
// Note 480p is recommended for D435 and 720p for D415
const int stream_width = 1280;
const int stream_height = 720;
// const int stream_width = 848;
// const int stream_height = 480;
const int stream_fps = 30;
// const int depth_disparity_shift = 24;
...
int main(int argc, char * argv[]) try {
    ...
    // Added by Shrek - Load in JSON file generated from Realsense Viewer
    if (dev.is<rs400::advanced_mode>())
    {
        ...
        // std::ifstream t("../realsense-custom-settings-001.json", std::ifstream::binary);
        // std::string str((std::istreambuf_iterator<char>(t)),
        //     std::istreambuf_iterator<char>());
        // std::string json_content = str;
        // std::cout << "Advanced Mode JSON File Loaded: " << "realsense-custom-settings-001.json" << " Char Count: " << json_content.length();
    ...
    //     std::cout << "Disparity Shift set to 24";
